...
import { ExternalLinkIcon, Loader2Icon, MailIcon, MailOpenIcon, Trash2Icon } from 'lucide-react'
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>{formatRelativeTime(message.createdAt)}</DialogDescription>
        </DialogHeader>
