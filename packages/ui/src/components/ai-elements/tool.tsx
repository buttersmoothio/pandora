...
const statusIcons: Record<ToolPart['state'], ReactNode> = {
  ...
  'approval-responded': <CheckCircleIcon className="size-4 text-teal-600 dark:text-teal-400" />,
  'input-available': <ClockIcon className="size-4 animate-pulse" />,
  'input-streaming': <CircleIcon className="size-4" />,
  'output-available': <CheckCircleIcon className="size-4 text-emerald-700 dark:text-emerald-400" />,
  'output-denied': <XCircleIcon className="size-4 text-orange-700 dark:text-orange-400" />,
  'output-error': <XCircleIcon className="size-4 text-rose-600 dark:text-rose-400" />,
}
