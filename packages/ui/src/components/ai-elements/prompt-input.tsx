...
export const PromptInput = ({
  ...
  const handleSubmit: FormEventHandler<HTMLFormElement> = useCallback(
    // biome-ignore lint/complexity/noExcessiveCognitiveComplexity: form submit with file conversion and error handling
    async (event) => {
...
export const PromptInputTextarea = ({
  ...
  const handleKeyDown: KeyboardEventHandler<HTMLTextAreaElement> = useCallback(
    // biome-ignore lint/complexity/noExcessiveCognitiveComplexity: keyboard handling with composition and attachment logic
    (e) => {
