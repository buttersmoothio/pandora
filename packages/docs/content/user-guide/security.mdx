...
If you are [building a custom UI](/extending/react-sdk), you are responsible for setting your own CSP. See the [security recommendations](/extending/react-sdk/security) in that guide.
