...
Endpoint reference for authenticating requests and managing sessions. See [API Conventions](/developer-guide/reference/conventions) for the shared error format and status codes.
