...
If you are [building a custom UI](/extending-pandora/building-a-custom-ui), you are responsible for setting your own CSP. See the security recommendations in that guide.
