...
<details>
<summary>**conversations** — Holds both top-level user conversations and subagent threads.</summary>
...
<details>
<summary>**messages** — Metadata for each message. Content lives in `message_parts`.</summary>
...
<details>
<summary>**message_parts** — Ordered, heterogeneous content parts for each message.</summary>
