...
For live internet searches. See the dedicated [Web Search Guide](/web-search).
...
See [Customization → Sub-agents](/customization#sub-agents) for how to create your own specialists.
