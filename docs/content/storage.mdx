...
See [Customization → Storage backends](/customization#storage-backends) for how to create your own.
...
**Fix:** Use `sqlite` or `memory`, or [create a custom backend](/customization#storage-backends).
